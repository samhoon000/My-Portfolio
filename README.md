...
*An end-to-end data analytics and business intelligence solution analyzing over 3.4 million customer orders to uncover purchasing behavior, product performance, and customer retention insights.*
*   **Tech Stack:** Power BI, Python, DuckDB, SQL, Pandas, Data Analytics
...
*   **Links:** [📁 Code Repository](https://github.com/samhoon000/instacart-customer-analytics)
