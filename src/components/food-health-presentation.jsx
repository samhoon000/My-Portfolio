...
export function FoodHealthPresentation() {
  return (
    <div className="mx-auto max-w-6xl px-4 pt-24 pb-12 sm:px-6 lg:px-8 min-h-screen animate-reveal">
      ...
      <div className="mb-8">
        <h1 className="font-display text-3xl font-bold text-textPrimary">Project Presentation</h1>
        <p className="mt-2 text-sm text-textMuted font-sans">
          Presentation used to explain the project, methodology, and key business outcomes.
        </p>
      </div>

      <div className="glass-card rounded-2xl overflow-hidden border border-stroke bg-panel shadow-card h-[80vh] w-full">
        <iframe 
          src="/food-health-presentation.pdf" 
          className="w-full h-full border-none bg-white"
          title="Food Nutrition & Health Risk Analytics System - Project Presentation"
        />
      </div>
    </div>
  )
